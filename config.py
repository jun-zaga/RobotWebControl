...
# These keep older files working if they use WALL_TARGET_MM style names.
# -------------------------------------------------

WALL_TARGET_MM = WALL_FOLLOW_TARGET_MM
WALL_TOLERANCE_MM = WALL_FOLLOW_TOLERANCE_MM
WALL_LOST_MM = WALL_FOLLOW_WALL_LOST_MM

WALL_BASE_SPEED = WALL_FOLLOW_BASE_SPEED
WALL_MAX_TURN = WALL_FOLLOW_MAX_TURN
WALL_SEARCH_TURN = WALL_FOLLOW_SEARCH_TURN
WALL_FRONT_STOP_MM = WALL_FOLLOW_FRONT_STOP_MM

WALL_LOOP_HZ = WALL_FOLLOW_LOOP_HZ
WALL_TURN_GAIN = WALL_FOLLOW_TURN_GAIN
WALL_FORWARD_SIGN = WALL_FOLLOW_FORWARD_SIGN
WALL_TURN_SIGN = WALL_FOLLOW_TURN_SIGN

WALL_LEFT_BODY_OFFSET_MM = WALL_FOLLOW_LEFT_BODY_OFFSET_MM
WALL_RIGHT_BODY_OFFSET_MM = WALL_FOLLOW_RIGHT_BODY_OFFSET_MM
WALL_MIN_MOTOR_POWER = WALL_FOLLOW_MIN_MOTOR_POWER
